...
// background, with the same signal-teal "P" monogram as app/icon.svg.
...
<svg width="180" height="180" viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    ...
    <radialGradient id="g" cx="90" cy="84" r="62" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#58c4b9" stop-opacity="0.32"/>
      <stop offset="1" stop-color="#58c4b9" stop-opacity="0"/>
    </radialGradient>
  </defs>
  <rect width="180" height="180" fill="url(#t)"/>
  <circle cx="90" cy="84" r="58" fill="url(#g)"/>
  <g stroke="#58c4b9" stroke-width="17" stroke-linecap="round" stroke-linejoin="round" fill="none">
